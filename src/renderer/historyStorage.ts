 ...
 */
export async function loadHistoryEntries(storage: PluginStorage): Promise<HistoryEntry[]> {
 ...
 * @param storage - Plugin-scoped persistent storage.
 */
export async function clearHistoryEntries(storage: PluginStorage): Promise<void> {
